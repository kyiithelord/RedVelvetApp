...
<body>
    ...
    <div class="container mx-auto mt-10 p-">
        <div class="w-full max-w-md mx-auto  bg-white shadow-lg rounded-lg p-e">
            <form action="{{route('student.store')}}" method="post" class="grid gap-4 mb-6" >
                @csrf
                <div class="mb-2">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Add Student</label>
